...
.method static getCachedPower(IIILorg/mozilla/javascript/v8dtoa/DiyFp;)I
    ...
    .param p1, "alpha"    # I
    .param p2, "gamma"    # I
    .param p3, "c_mk"    # Lorg/mozilla/javascript/v8dtoa/DiyFp;
    ...
    const-wide v7, 0x3fd34413509f79feL    # 0.30102999566398114
    ...
    .line 55
    .local v1, "index":I
    sget-object v5, Lorg/mozilla/javascript/v8dtoa/CachedPowers;->CACHED_POWERS:[Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;

    aget-object v0, v5, v1

    .line 57
    .local v0, "cachedPower":Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;
    iget-wide v5, v0, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;->significand:J

    invoke-virtual {p3, v5, v6}, Lorg/mozilla/javascript/v8dtoa/DiyFp;->setF(J)V

    .line 58
    iget-short v5, v0, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;->binaryExponent:S

    invoke-virtual {p3, v5}, Lorg/mozilla/javascript/v8dtoa/DiyFp;->setE(I)V

    .line 59
    sget-boolean v5, Lorg/mozilla/javascript/v8dtoa/CachedPowers;->$assertionsDisabled:Z
    ...
    .line 60
    :cond_1
    iget-short v5, v0, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;->decimalExponent:S
