...
.method private b(Ljava/lang/String;)Lorg/objectweb/asm/Item;
    ...
    iput v2, p0, Lorg/objectweb/asm/ClassWriter;->c:I
...
.method a(II)I
    ...
    iput v5, v0, Lorg/objectweb/asm/Item;->b:I
...
.method a(D)Lorg/objectweb/asm/Item;
    ...
    iget-wide v1, v1, Lorg/objectweb/asm/Item;->d:J
...
.method public toByteArray()[B
    ...
    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->A:Lorg/objectweb/asm/ByteVector;
    ...
    invoke-virtual {p0, v2}, Lorg/objectweb/asm/ClassWriter;->newUTF8(Ljava/lang/String;)I

    :goto_2
    iget v2, p0, Lorg/objectweb/asm/ClassWriter;->m:I
    ...
    :cond_3
    iget v2, p0, Lorg/objectweb/asm/ClassWriter;->q:I
    ...
    :cond_4
    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->r:Lorg/objectweb/asm/ByteVector;
    ...
    :cond_5
    iget v2, p0, Lorg/objectweb/asm/ClassWriter;->s:I
    ...
    :cond_6
    iget v2, p0, Lorg/objectweb/asm/ClassWriter;->k:I
    ...
    iget v2, p0, Lorg/objectweb/asm/ClassWriter;->b:I
    ...
    :cond_9
    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->y:Lorg/objectweb/asm/ByteVector;
    ...
    :cond_a
    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->u:Lorg/objectweb/asm/AnnotationWriter;
    ...
    :cond_b
    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->v:Lorg/objectweb/asm/AnnotationWriter;
    ...
    iget-object v1, p0, Lorg/objectweb/asm/ClassWriter;->w:Lorg/objectweb/asm/Attribute;
    ...
    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->d:Lorg/objectweb/asm/ByteVector;
    ...
    invoke-virtual {v0, v2, v3, v5}, Lorg/objectweb/asm/ByteVector;->putByteArray([BII)Lorg/objectweb/asm/ByteVector;
    ...
    :goto_4
    iget v2, p0, Lorg/objectweb/asm/ClassWriter;->o:I

    if-ge v0, v2, :cond_d

    iget-object v2, p0, Lorg/objectweb/asm/ClassWriter;->p:[I

    aget v2, v2, v0

    invoke-virtual {v6, v2}, Lorg/objectweb/asm/ByteVector;->putShort(I)Lorg/objectweb/asm/ByteVector;
    ...
    invoke-virtual {v0, v10}, Lorg/objectweb/asm/ByteVector;->putInt(I)Lorg/objectweb/asm/ByteVector;
    ...
    invoke-virtual {v6, v1, v10, v0}, Lorg/objectweb/asm/ByteVector;->putByteArray([BII)Lorg/objectweb/asm/ByteVector;
    ...
    invoke-virtual {v0, v12}, Lorg/objectweb/asm/ByteVector;->putInt(I)Lorg/objectweb/asm/ByteVector;
    ...
    invoke-direct {v0, v10}, Lorg/objectweb/asm/ClassWriter;-><init>(I)V

    new-instance v1, Lorg/objectweb/asm/ClassReader;

    iget-object v2, v6, Lorg/objectweb/asm/ByteVector;->a:[B

    invoke-direct {v1, v2}, Lorg/objectweb/asm/ClassReader;-><init>([B)V

    invoke-virtual {v1, v0, v12}, Lorg/objectweb/asm/ClassReader;->accept(Lorg/objectweb/asm/ClassVisitor;I)V
...
.method public final visitSource(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lorg/objectweb/asm/ByteVector;->putUTF8(Ljava/lang/String;)Lorg/objectweb/asm/ByteVector;
