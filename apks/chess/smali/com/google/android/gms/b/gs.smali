.class public Lcom/google/android/gms/b/gs;
...
.method public constructor <init>(Lcom/google/android/gms/b/lb;Ljava/util/Map;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/b/gs;->a:Ljava/util/Map;

    invoke-interface {p1}, Lcom/google/android/gms/b/lb;->f()Landroid/app/Activity;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/b/gs;->b:Landroid/content/Context;

    return-void
.end method

.method static synthetic a(Lcom/google/android/gms/b/gs;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/b/gs;->b:Landroid/content/Context;
...
.method a(Ljava/lang/String;Ljava/lang/String;)Landroid/app/DownloadManager$Request;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/b/kb;->a(Landroid/app/DownloadManager$Request;)Z
...
.method public a()V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/b/gs;->b(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/b/gs;->b:Landroid/content/Context;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/b/gs;->a:Ljava/util/Map;
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lcom/google/android/gms/b/gs;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/gms/b/ka;->c(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/b/jp;->o()Landroid/content/res/Resources;
    ...
    iget-object v4, p0, Lcom/google/android/gms/b/gs;->b:Landroid/content/Context;

    invoke-virtual {v1, v4}, Lcom/google/android/gms/b/ka;->d(Landroid/content/Context;)Landroid/app/AlertDialog$Builder;

    move-result-object v4

    if-eqz v3, :cond_7

    sget v1, Lcom/google/android/gms/a$c;->store_picture_title:I
    ...
    sget v1, Lcom/google/android/gms/a$c;->store_picture_message:I
    ...
    :goto_5
    new-instance v5, Lcom/google/android/gms/b/gs$1;

    invoke-direct {v5, p0, v0, v2}, Lcom/google/android/gms/b/gs$1;-><init>(Lcom/google/android/gms/b/gs;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_6
    new-instance v1, Lcom/google/android/gms/b/gs$2;

    invoke-direct {v1, p0}, Lcom/google/android/gms/b/gs$2;-><init>(Lcom/google/android/gms/b/gs;)V
