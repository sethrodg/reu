...
.method public static getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p0, p1, p2}, Lcom/google/android/gms/common/k;->getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
...
.method public static getErrorString(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->getErrorString(I)Ljava/lang/String;
...
.method public static getOpenSourceSoftwareLicenseInfo(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->getOpenSourceSoftwareLicenseInfo(Landroid/content/Context;)Ljava/lang/String;
...
.method public static getRemoteContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->getRemoteContext(Landroid/content/Context;)Landroid/content/Context;
...
.method public static getRemoteResource(Landroid/content/Context;)Landroid/content/res/Resources;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->getRemoteResource(Landroid/content/Context;)Landroid/content/res/Resources;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->isGooglePlayServicesAvailable(Landroid/content/Context;)I
...
.method public static isUserRecoverableError(I)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->isUserRecoverableError(I)Z
...
.method public static showErrorDialogFragment(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-static {p0, p1, v0, p2, p3}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->showErrorDialogFragment(ILandroid/app/Activity;Landroid/support/v4/app/i;ILandroid/content/DialogInterface$OnCancelListener;)Z
...
.method public static showErrorDialogFragment(ILandroid/app/Activity;Landroid/support/v4/app/i;ILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 3
    ...
    invoke-static {p2, v1, p3}, Lcom/google/android/gms/common/internal/s;->a(Landroid/support/v4/app/i;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/s;

    move-result-object v1

    invoke-virtual {v0, p1, p0, v1, p4}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/s;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {v0, p1, v1, v2, p4}, Lcom/google/android/gms/common/b;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p0, v1, v2}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/r;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    if-nez v0, :cond_0

    sget v0, Lcom/google/android/gms/a$c;->common_google_play_services_notification_ticker:I
    ...
    :cond_0
    invoke-static {p1, p0, v2}, Lcom/google/android/gms/common/internal/r;->b(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/r;->e()Z
    ...
    sget v4, Lcom/google/android/gms/a$b;->common_ic_googleplayservices:I
    ...
    sget v2, Lcom/google/android/gms/a$b;->common_full_open_on_phone:I
    ...
    :cond_1
    sget v3, Lcom/google/android/gms/a$c;->common_google_play_services_notification_ticker:I
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/r;->i()Z
    ...
    :cond_5
    new-instance v3, Landroid/support/v4/app/w$d;

    invoke-direct {v3, p1}, Landroid/support/v4/app/w$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v4}, Landroid/support/v4/app/w$d;->a(I)Landroid/support/v4/app/w$d;

    move-result-object v3

    invoke-virtual {v3, v1}, Landroid/support/v4/app/w$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/w$d;
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/app/w$d;->a(J)Landroid/support/v4/app/w$d;

    move-result-object v1

    invoke-virtual {v1, v6}, Landroid/support/v4/app/w$d;->a(Z)Landroid/support/v4/app/w$d;

    move-result-object v1

    invoke-virtual {v1, p3}, Landroid/support/v4/app/w$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/w$d;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/support/v4/app/w$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/w$d;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/app/w$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/w$d;
...
.method public static zzc(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/k;->zzc(Landroid/content/Context;I)Z
...
.method public static zzd(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/k;->zzd(Landroid/content/Context;I)Z
...
.method public static zzfd(I)Landroid/content/Intent;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/k;->zzfd(I)Landroid/content/Intent;
