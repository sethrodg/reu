...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/multidex/b;->a:Ljava/lang/reflect/Method;
    :try_end_0
...
.method static a(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;
    ...
    invoke-static {v1}, Landroid/support/multidex/b;->c(Ljava/io/File;)J

    move-result-wide v4

    if-nez p3, :cond_0

    invoke-static {p0, v1, v4, v5}, Landroid/support/multidex/b;->a(Landroid/content/Context;Ljava/io/File;J)Z
    ...
    invoke-static {v1, p2}, Landroid/support/multidex/b;->a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;

    move-result-object v0

    invoke-static {v1}, Landroid/support/multidex/b;->b(Ljava/io/File;)J
    ...
    invoke-static/range {v1 .. v6}, Landroid/support/multidex/b;->a(Landroid/content/Context;JJI)V
...
.method private static a(Landroid/content/Context;Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-static {v5}, Landroid/support/multidex/b;->a(Ljava/io/File;)Z
...
.method private static a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-static {p1, v6}, Landroid/support/multidex/b;->a(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Landroid/support/multidex/b;->a(Ljava/io/File;)Z
...
.method private static a(Landroid/content/Context;JJI)V
    ...
    invoke-static {v0}, Landroid/support/multidex/b;->a(Landroid/content/SharedPreferences$Editor;)V
...
.method private static a(Landroid/content/SharedPreferences$Editor;)V
    ...
    sget-object v0, Landroid/support/multidex/b;->a:Ljava/lang/reflect/Method;
...
.method private static a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Landroid/support/multidex/b;->a(Ljava/io/Closeable;)V
