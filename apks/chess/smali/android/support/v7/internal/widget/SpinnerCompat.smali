...
.field private F:Landroid/support/v7/widget/b$b;

.field private G:Landroid/support/v7/internal/widget/SpinnerCompat$d;

.field private H:Landroid/support/v7/internal/widget/SpinnerCompat$b;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, v0, p3, v4}, Landroid/support/v7/internal/widget/q;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/q;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/SpinnerCompat$d;

    sget v2, Landroid/support/v7/b/a$i;->Spinner_prompt:I

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/q;->c(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/SpinnerCompat$b;

    if-eqz v1, :cond_1

    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/SpinnerCompat$d;

    iget-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/SpinnerCompat$b;

    invoke-interface {v1, v2}, Landroid/support/v7/internal/widget/SpinnerCompat$d;->a(Landroid/widget/ListAdapter;)V

    iput-object v5, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/SpinnerCompat$b;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->L:Landroid/support/v7/internal/widget/o;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v7/internal/widget/SpinnerCompat$a;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/support/v7/internal/widget/SpinnerCompat$1;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/SpinnerCompat$d;
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroid/support/v7/internal/widget/SpinnerCompat$c;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget v2, Landroid/support/v7/b/a$i;->Spinner_android_dropDownWidth:I

    const/4 v3, -0x2

    invoke-virtual {v0, v2, v3}, Landroid/support/v7/internal/widget/q;->e(II)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/internal/widget/SpinnerCompat$c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/b$b;
...
.method static synthetic a(Landroid/support/v7/internal/widget/SpinnerCompat;)Landroid/support/v7/internal/widget/SpinnerCompat$d;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/SpinnerCompat$d;
...
.method a(IZ)V
    ...
    invoke-static {v5, v4}, Landroid/support/v4/g/b;->a(II)I
...
.method a(Landroid/support/v7/internal/widget/d$b;)V
    .locals 0
...
.method public a(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/SpinnerCompat$b;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/b$b;
