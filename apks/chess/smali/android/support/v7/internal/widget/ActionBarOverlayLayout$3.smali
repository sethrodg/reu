...
.method public run()V
    ...
    invoke-static {v1}, Landroid/support/v4/g/o;->f(Landroid/view/View;)Landroid/support/v4/g/x;

    move-result-object v1

    invoke-virtual {v1, v3}, Landroid/support/v4/g/x;->b(F)Landroid/support/v4/g/x;
    ...
    invoke-static {v2}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/g/aa;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/g/x;->a(Landroid/support/v4/g/aa;)Landroid/support/v4/g/x;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/g/x;)Landroid/support/v4/g/x;
    ...
    invoke-static {v2}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->e(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/g/aa;
    ...
    invoke-static {v0, v1}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/g/x;)Landroid/support/v4/g/x;
