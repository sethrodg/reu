...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Landroid/support/v7/b/a$i;->LinearLayoutCompat:[I

    invoke-static {p1, p2, v0, p3, v3}, Landroid/support/v7/internal/widget/q;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/q;

    move-result-object v0

    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_android_orientation:I
    ...
    :cond_0
    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_android_gravity:I
    ...
    :cond_1
    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_android_baselineAligned:I
    ...
    :cond_2
    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_android_weightSum:I

    const/high16 v2, -0x40800000    # -1.0f

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/internal/widget/q;->a(IF)F

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/LinearLayoutCompat;->g:F

    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_android_baselineAlignedChildIndex:I
    ...
    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_measureWithLargestChild:I

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/internal/widget/q;->a(IZ)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/widget/LinearLayoutCompat;->h:Z

    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_divider:I
    ...
    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_showDividers:I

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/internal/widget/q;->a(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/LinearLayoutCompat;->n:I

    sget v1, Landroid/support/v7/b/a$i;->LinearLayoutCompat_dividerPadding:I

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/internal/widget/q;->d(II)I
...
.method private d(II)V
    ...
    iget v0, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->height:I

    const/4 v2, -0x1

    if-ne v0, v2, :cond_0

    iget v8, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I

    invoke-virtual {v1}, Landroid/view/View;->getMeasuredWidth()I

    move-result v0

    iput v0, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
    ...
    iput v8, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
...
.method a(II)V
    ...
    iget v7, v0, Landroid/support/v7/widget/LinearLayoutCompat;->m:I
    ...
    iget v3, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->g:F
    ...
    iget v3, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->height:I
    ...
    iget v6, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->topMargin:I

    add-int/2addr v6, v3

    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
    ...
    iget v6, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->g:F
    ...
    iput v6, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->height:I
    ...
    iget v8, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->topMargin:I

    add-int/2addr v7, v8

    iget v8, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
    ...
    iput v6, v0, Landroid/support/v7/widget/LinearLayoutCompat;->f:I
    ...
    :goto_4
    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I

    iget v8, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->rightMargin:I
    ...
    invoke-static {v4}, Landroid/support/v4/g/o;->c(Landroid/view/View;)I

    move-result v7

    move/from16 v0, v18

    invoke-static {v0, v7}, Landroid/support/v7/internal/widget/s;->a(II)I

    move-result v11

    if-eqz v17, :cond_a

    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
    ...
    iget v9, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->topMargin:I
    ...
    invoke-static {v3, v0, v4}, Landroid/support/v4/g/o;->a(III)I
    ...
    iget v6, v0, Landroid/support/v7/widget/LinearLayoutCompat;->g:F
    ...
    iget v13, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I

    add-int/2addr v8, v13

    iget v13, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->rightMargin:I

    add-int/2addr v8, v13

    iget v13, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
    ...
    iget v13, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->height:I
    ...
    :goto_d
    invoke-static {v15}, Landroid/support/v4/g/o;->c(Landroid/view/View;)I

    move-result v4

    and-int/lit16 v4, v4, -0x100

    invoke-static {v7, v4}, Landroid/support/v7/internal/widget/s;->a(II)I
    ...
    :goto_e
    iget v7, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I

    iget v8, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->rightMargin:I
    ...
    iget v7, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
    ...
    invoke-static {v3, v0, v1}, Landroid/support/v4/g/o;->a(III)I
...
.method a(IIII)V
    ...
    iget v0, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->h:I
    ...
    :cond_1
    invoke-static {p0}, Landroid/support/v4/g/o;->b(Landroid/view/View;)I

    move-result v2

    invoke-static {v0, v2}, Landroid/support/v4/g/b;->a(II)I
    ...
    iget v0, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I
    ...
    iget v0, p0, Landroid/support/v7/widget/LinearLayoutCompat;->m:I

    add-int/2addr v0, v3

    :goto_4
    iget v3, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->topMargin:I
    ...
    iget v0, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
    ...
    iget v2, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I

    add-int/2addr v0, v2

    iget v2, v6, Landroid/support/v7/widget/LinearLayoutCompat$a;->rightMargin:I
...
.method b(II)V
    ...
    iget v3, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
    ...
    iget v6, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I

    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->rightMargin:I
    ...
    :goto_5
    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->topMargin:I
    ...
    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->h:I
    ...
    iget v7, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->height:I
    ...
    iput v6, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->width:I
    ...
    iget v8, v10, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->leftMargin:I
    ...
    iget v13, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
    ...
    :goto_12
    invoke-static/range {v16 .. v16}, Landroid/support/v4/g/o;->c(Landroid/view/View;)I
    ...
    iget v4, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->height:I
    ...
    :goto_15
    iget v5, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->topMargin:I

    iget v6, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->h:I
    ...
    :cond_28
    iget v3, v3, Landroid/support/v7/widget/LinearLayoutCompat$a;->h:I
    ...
    invoke-static {v3, v0, v5}, Landroid/support/v4/g/o;->a(III)I
...
.method b(IIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/g/o;->b(Landroid/view/View;)I

    move-result v3

    invoke-static {v2, v3}, Landroid/support/v4/g/b;->a(II)I
    ...
    :goto_4
    iget v4, v8, Landroid/support/v7/widget/LinearLayoutCompat$a;->h:I
    ...
    iget v2, v0, Landroid/support/v7/widget/LinearLayoutCompat;->l:I
    ...
    iget v4, v8, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
    ...
    iget v5, v8, Landroid/support/v7/widget/LinearLayoutCompat$a;->bottomMargin:I
...
.method protected g()Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 3
...
.method protected synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/LinearLayoutCompat;->g()Landroid/support/v7/widget/LinearLayoutCompat$a;
