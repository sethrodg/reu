...
# interfaces
.implements Landroid/support/v7/internal/view/menu/e$b;
...
# instance fields
.field private a:Landroid/support/v7/internal/view/menu/e;
...
.field private f:Landroid/support/v7/widget/a;
...
.field private m:Landroid/support/v7/widget/ActionMenuView$e;
...
.method static synthetic a(Landroid/support/v7/widget/ActionMenuView;)Landroid/support/v7/widget/ActionMenuView$e;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->m:Landroid/support/v7/widget/ActionMenuView$e;

    return-object v0
.end method

.method static synthetic b(Landroid/support/v7/widget/ActionMenuView;)Landroid/support/v7/internal/view/menu/e$a;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->h:Landroid/support/v7/internal/view/menu/e$a;
...
.method public a(Landroid/support/v7/internal/view/menu/e;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/e;

    return-void
.end method

.method public a(Landroid/support/v7/internal/view/menu/j$a;Landroid/support/v7/internal/view/menu/e$a;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->g:Landroid/support/v7/internal/view/menu/j$a;

    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->h:Landroid/support/v7/internal/view/menu/e$a;
...
.method public a(Landroid/support/v7/internal/view/menu/f;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/e;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Landroid/support/v7/internal/view/menu/e;->a(Landroid/view/MenuItem;I)Z
...
.method public synthetic b(Landroid/util/AttributeSet;)Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 1
...
.method protected synthetic b(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 1
...
.method public c()Landroid/support/v7/internal/view/menu/e;
    .locals 1
...
.method public d()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->f:Landroid/support/v7/widget/a;
...
.method protected synthetic g()Landroid/support/v7/widget/LinearLayoutCompat$a;
    .locals 1
...
.method public getMenu()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Landroid/support/v7/internal/view/menu/e;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/e;

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/e;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/internal/view/menu/e;->a(Landroid/support/v7/internal/view/menu/e$a;)V

    new-instance v1, Landroid/support/v7/widget/a;

    invoke-direct {v1, v0}, Landroid/support/v7/widget/a;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Landroid/support/v7/widget/a;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->f:Landroid/support/v7/widget/a;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/a;->b(Z)V

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Landroid/support/v7/widget/a;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->g:Landroid/support/v7/internal/view/menu/j$a;
    ...
    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/a;->a(Landroid/support/v7/internal/view/menu/j$a;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/a;->a(Landroid/support/v7/widget/ActionMenuView;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/a;->a(Z)V
...
.method protected onMeasure(II)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuView;->a:Landroid/support/v7/internal/view/menu/e;
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/a;->c(Z)V
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/ActionMenuView$e;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->m:Landroid/support/v7/widget/ActionMenuView$e;
...
.method public setPresenter(Landroid/support/v7/widget/a;)V
    .locals 1

    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Landroid/support/v7/widget/a;
