...
.field k:Landroid/support/v4/app/i;
...
.method public constructor <init>(Landroid/support/v4/app/i;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/i;->I:Ljava/lang/String;
    ...
    iget-object v0, p1, Landroid/support/v4/app/i;->r:Landroid/os/Bundle;
...
# virtual methods
.method public a(Landroid/support/v4/app/m;Landroid/support/v4/app/i;)Landroid/support/v4/app/i;
    .locals 3

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;
    ...
    iput-object v1, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;
    ...
    iput-object v1, v0, Landroid/support/v4/app/i;->n:Landroid/os/Bundle;
    ...
    invoke-virtual {v0, v1, p2}, Landroid/support/v4/app/i;->a(ILandroid/support/v4/app/i;)V

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;

    iget-boolean v1, p0, Landroid/support/v4/app/FragmentState;->c:Z

    iput-boolean v1, v0, Landroid/support/v4/app/i;->y:Z

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v4/app/i;->A:Z
    ...
    iput v1, v0, Landroid/support/v4/app/i;->H:I

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;

    iget-object v1, p0, Landroid/support/v4/app/FragmentState;->f:Ljava/lang/String;

    iput-object v1, v0, Landroid/support/v4/app/i;->I:Ljava/lang/String;

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;

    iget-boolean v1, p0, Landroid/support/v4/app/FragmentState;->g:Z

    iput-boolean v1, v0, Landroid/support/v4/app/i;->L:Z
    ...
    iput-object v1, v0, Landroid/support/v4/app/i;->C:Landroid/support/v4/app/o;
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentState;->k:Landroid/support/v4/app/i;
