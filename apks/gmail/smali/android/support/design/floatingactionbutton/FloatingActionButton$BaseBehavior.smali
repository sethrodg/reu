...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T:",
        "Landroid/support/design/floatingactionbutton/FloatingActionButton;",
        ">",
        "Lalw<",
        "TT;>;"
    }
...
.method private final a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/support/design/appbar/AppBarLayout;Landroid/support/design/floatingactionbutton/FloatingActionButton;)Z
    ...
    .line 9
    invoke-virtual {p3}, Landroid/support/design/floatingactionbutton/FloatingActionButton;->f()V

    goto :goto_0

    .line 10
    :cond_1
    invoke-virtual {p3}, Landroid/support/design/floatingactionbutton/FloatingActionButton;->e()V
...
.method private final b(Landroid/view/View;Landroid/support/design/floatingactionbutton/FloatingActionButton;)Z
    ...
    invoke-virtual {p2}, Landroid/support/design/floatingactionbutton/FloatingActionButton;->f()V

    goto :goto_0

    .line 6
    :cond_0
    invoke-virtual {p2}, Landroid/support/design/floatingactionbutton/FloatingActionButton;->e()V
...
.method public final synthetic a(Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    iget-object v0, p1, Landroid/support/design/floatingactionbutton/FloatingActionButton;->c:Landroid/graphics/Rect;
...
.method public final synthetic a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    instance-of v5, v4, Landroid/support/design/appbar/AppBarLayout;

    if-eqz v5, :cond_0

    check-cast v4, Landroid/support/design/appbar/AppBarLayout;

    invoke-direct {p0, p1, v4, p2}, Landroid/support/design/floatingactionbutton/FloatingActionButton$BaseBehavior;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/support/design/appbar/AppBarLayout;Landroid/support/design/floatingactionbutton/FloatingActionButton;)Z
    ...
    .line 32
    :cond_0
    invoke-static {v4}, Landroid/support/design/floatingactionbutton/FloatingActionButton$BaseBehavior;->b(Landroid/view/View;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-direct {p0, v4, p2}, Landroid/support/design/floatingactionbutton/FloatingActionButton$BaseBehavior;->b(Landroid/view/View;Landroid/support/design/floatingactionbutton/FloatingActionButton;)Z
    ...
    .line 17
    iget-object p3, p2, Landroid/support/design/floatingactionbutton/FloatingActionButton;->c:Landroid/graphics/Rect;
    ...
    iget v4, v0, Lalx;->bottomMargin:I
    ...
    .line 25
    invoke-static {p2, v1}, Ltu;->e(Landroid/view/View;I)V
