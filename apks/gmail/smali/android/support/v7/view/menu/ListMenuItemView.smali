...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lyo;->bK:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Laiv;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Laiv;
    ...
    invoke-virtual {p2, p3}, Laiv;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Laiv;->f(II)I
    ...
    invoke-virtual {p2, p3, v2}, Laiv;->a(IZ)Z
...
.method public final a()Laap;
    ...
    .line 4
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Laap;
...
.method public final a(Laap;)V
    ...
    .line 5
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Laap;
    ...
    :cond_3
    iget-object v3, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Laap;

    invoke-virtual {v3}, Laap;->e()Z
    ...
    :cond_a
    :goto_5
    invoke-virtual {p1}, Laap;->d()Z

    move-result v0

    invoke-virtual {p1}, Laap;->c()C
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Laap;

    invoke-virtual {v4}, Laap;->c()C
    ...
    :cond_d
    iget-object v6, v4, Laap;->i:Laal;

    iget-object v6, v6, Laal;->a:Landroid/content/Context;
    ...
    iget-object v8, v4, Laap;->i:Laal;

    iget-object v8, v8, Laal;->a:Landroid/content/Context;
    ...
    invoke-static {v7, v4, v8, v9}, Laap;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v7, v4, v2, v8}, Laap;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    iget-object v3, v3, Laap;->i:Laal;

    iget-boolean v3, v3, Laal;->h:Z
    ...
    :cond_1d
    iget-object p1, p1, Laap;->k:Ljava/lang/CharSequence;
