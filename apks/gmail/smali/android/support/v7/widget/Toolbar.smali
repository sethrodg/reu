...
.field private final M:Lacf;

.field private N:Laje;
...
.field public r:Landroid/support/v7/widget/ActionMenuPresenter;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->p:Ljava/util/ArrayList;
    ...
    invoke-direct {p1, p0}, Laix;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->M:Lacf;

    .line 9
    new-instance p1, Laiw;

    invoke-direct {p1, p0}, Laiw;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-virtual {p1, p2, p3}, Laiv;->b(II)I
    ...
    invoke-virtual {p1, p3}, Laiv;->h(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Laiv;->c(II)I
    ...
    invoke-virtual {p1, p2, p3}, Laiv;->c(II)I
    ...
    invoke-virtual {p1, p2, p3}, Laiv;->d(II)I
    ...
    invoke-virtual {p1, v0, p3}, Laiv;->c(II)I
    ...
    invoke-virtual {p1, v2, v1}, Laiv;->d(II)I

    move-result v2

    sget v3, Lyo;->cK:I

    invoke-virtual {p1, v3, v1}, Laiv;->d(II)I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/Toolbar;->m:Laig;

    iput-boolean v1, v4, Laig;->h:Z
    ...
    .line 27
    :goto_1
    invoke-virtual {v4, p2, v0}, Laig;->a(II)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/Toolbar;->d(I)V
...
.method private final a(Landroid/view/View;I)I
    ...
    .line 5
    iget p1, v0, Lajb;->bottomMargin:I
...
.method private static a(Landroid/view/ViewGroup$LayoutParams;)Lajb;
    .locals 1

    .line 20
    instance-of v0, p0, Lajb;
    ...
    invoke-direct {v0, p0}, Lajb;-><init>(Lajb;)V
    ...
    invoke-direct {v0, p0}, Lajb;-><init>(Lwa;)V
    ...
    invoke-direct {v0, p0}, Lajb;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p0}, Lajb;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private final a(Landroid/view/View;Z)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Lajb;
...
.method private final l()I
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->m:Laig;

    if-eqz v0, :cond_1

    .line 2
    iget-boolean v1, v0, Laig;->g:Z
...
.method private final o()I
    ...
    .line 3
    :cond_0
    iget-object v0, v0, Landroid/support/v7/widget/ActionMenuView;->a:Laal;

    if-eqz v0, :cond_1

    .line 4
    invoke-virtual {v0}, Laal;->hasVisibleItems()Z
...
.method private final p()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lact;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v0}, Ladr;-><init>(Landroid/content/Context;)V
...
.method public final c()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->s:Laiy;
    ...
    .line 3
    invoke-virtual {v0}, Laap;->collapseActionView()Z
...
.method public final f()Landroid/view/Menu;
    ...
    .line 3
    iget-object v1, v0, Landroid/support/v7/widget/ActionMenuView;->a:Laal;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->s:Laiy;

    if-nez v1, :cond_1

    new-instance v1, Laiy;

    invoke-direct {v1, p0}, Laiy;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->s:Laiy;
    ...
    .line 7
    iget-object v1, v1, Landroid/support/v7/widget/ActionMenuView;->c:Landroid/support/v7/widget/ActionMenuPresenter;
...
.method public final g()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->M:Lacf;

    .line 2
    iput-object v1, v0, Landroid/support/v7/widget/ActionMenuView;->e:Lacf;

    .line 3
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->t:Labb;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->u:Laao;

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ActionMenuView;->a(Labb;Laao;)V
...
.method public final synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lajb;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-static {p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Lajb;
...
.method public final i()Ladz;
    .locals 2

    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Laje;
    ...
    invoke-direct {v0, p0, v1}, Laje;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Laje;
...
.method public final j()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->m:Laig;
...
.method public onLayout(ZIIII)V
    ...
    .line 3
    invoke-static/range {p0 .. p0}, Ltu;->m(Landroid/view/View;)I
    ...
    .line 4
    :goto_0
    iget-object v13, v0, Landroid/support/v7/widget/Toolbar;->w:Landroid/widget/ImageButton;
    ...
    .line 10
    iget-object v10, v0, Landroid/support/v7/widget/Toolbar;->g:Landroid/view/View;
    ...
    iget v13, v13, Lajb;->bottomMargin:I
    ...
    iget v2, v14, Lajb;->bottomMargin:I
    ...
    .line 52
    iget v2, v2, Lajb;->bottomMargin:I
    ...
    iget v1, v1, Lajb;->bottomMargin:I
    ...
    iget v13, v12, Lajb;->leftMargin:I

    sub-int/2addr v13, v6

    iget v6, v12, Lajb;->rightMargin:I
...
.method public onMeasure(II)V
    ...
    .line 3
    iget-object v0, v7, Landroid/support/v7/widget/Toolbar;->w:Landroid/widget/ImageButton;
    ...
    iget-object v1, v7, Landroid/support/v7/widget/Toolbar;->w:Landroid/widget/ImageButton;
    ...
    iget-object v2, v7, Landroid/support/v7/widget/Toolbar;->w:Landroid/widget/ImageButton;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->s:Laiy;
...
.method public final onRtlPropertiesChanged(I)V
    ...
    .line 3
    :goto_0
    iget-boolean p1, v0, Laig;->g:Z

    if-eq v1, p1, :cond_7

    .line 4
    iput-boolean v1, v0, Laig;->g:Z

    iget-boolean p1, v0, Laig;->h:Z
