...
.method static constructor <clinit>()V
    ...
    sput-object v0, Labdr;->a:Laeli;

    return-void
.end method

.method static a(Ljava/util/Collection;)Lyel;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1}, Lyeh;->a()Lyel;
    ...
    .line 3
    :cond_1
    invoke-static {v0}, Labdr;->a(Ljava/util/List;)Lyel;
...
.method private static a(Ljava/util/List;)Lyel;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static b(Ljava/util/Collection;)Lyem;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v4}, Lyem;->a()Lyel;

    move-result-object v5

    invoke-interface {v0, v5}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-interface {v4}, Lyem;->b()I
    ...
    .line 3
    invoke-interface {v4}, Lyem;->c()Ljava/util/Map;
    ...
    invoke-direct {p0, v0, v3, v1}, Labdn;-><init>(Lyel;ILaeli;)V
