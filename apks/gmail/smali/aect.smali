...
.field private static final b:Laecx;

.field private static final c:Laecx;
...
.method static constructor <clinit>()V
    ...
    .line 2
    sget-object v1, Laeaq;->a:Laeaj;

    .line 3
    invoke-static {v1}, Laecj;->a(Laeaj;)Laecj;
    ...
    invoke-static {v1, v6}, Laeaj;->a(CC)Laeaj;
    ...
    invoke-static {v6, v7}, Laeaj;->a(CC)Laeaj;

    move-result-object v6

    invoke-virtual {v1, v6}, Laeaj;->a(Laeaj;)Laeaj;
    ...
    invoke-virtual {v1, v2, v6}, Laecy;->a(CLjava/lang/String;)Laecy;

    const-string v2, "&gt;"

    invoke-virtual {v1, v4, v2}, Laecy;->a(CLjava/lang/String;)Laecy;

    invoke-virtual {v1}, Laecy;->a()Laecw;
    ...
    .line 16
    invoke-virtual {v1, v3}, Laeda;->a(I)Laeda;

    const/16 v2, 0x600

    const/16 v3, 0x603

    invoke-virtual {v1, v2, v3}, Laeda;->a(II)Laeda;

    const/16 v2, 0x6dd

    invoke-virtual {v1, v2}, Laeda;->a(I)Laeda;
    ...
    invoke-virtual {v1, v2, v5}, Laeda;->a(II)Laeda;
    ...
    invoke-virtual {v1, v0}, Laeda;->a(I)Laeda;
    ...
    invoke-virtual {v1, v0, v3}, Laeda;->a(II)Laeda;
    ...
    invoke-virtual {v1, v4}, Laeda;->a(I)Laeda;

    invoke-virtual {v1}, Laeda;->a()Laecx;

    move-result-object v1

    sput-object v1, Laect;->b:Laecx;
    ...
    invoke-virtual {v1, v2, v0}, Laeda;->a(II)Laeda;
    ...
    invoke-virtual {v2, v0}, Laeda;->a(Laecx;)Laeda;

    invoke-virtual {v2, v1}, Laeda;->a(Laecx;)Laeda;

    invoke-virtual {v2}, Laeda;->a()Laecx;

    move-result-object v0

    .line 22
    sput-object v0, Laect;->c:Laecx;
...
.method public static a(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    .line 6
    sget-object v7, Laecz;->a:Laecz;

    if-eq v1, v7, :cond_0

    .line 7
    sget-object v7, Laect;->b:Laecx;

    invoke-virtual {v7, v5}, Laecx;->a(I)Z
    ...
    .line 9
    :cond_1
    invoke-interface {v0, p0, v4, v3}, Ljava/lang/Appendable;->append(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;
    ...
    sget-object v9, Laect;->a:[C

    and-int/lit8 v7, v7, 0xf

    aget-char v7, v9, v7

    invoke-interface {v8, v7}, Ljava/lang/Appendable;->append(C)Ljava/lang/Appendable;

    move-result-object v7

    sget-object v8, Laect;->a:[C
    ...
    .line 12
    :cond_7
    invoke-static {v5, v0}, Laect;->a(ILjava/lang/Appendable;)V
    ...
    .line 33
    :cond_a
    invoke-interface {v0, p0, v4, v2}, Ljava/lang/Appendable;->append(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;
    :try_end_0
...
.method private static a(ILjava/lang/Appendable;)V
    ...
    invoke-static {v0, p1}, Laect;->a(ILjava/lang/Appendable;)V

    const/4 v0, 0x1

    aget-char p0, p0, v0

    invoke-static {p0, p1}, Laect;->a(ILjava/lang/Appendable;)V
