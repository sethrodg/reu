...
.method public constructor <init>(Lmgt;Ljava/util/concurrent/Executor;Lahac;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lmgc;->a:Lmgt;

    iput-object p2, p0, Lmgc;->b:Ljava/util/concurrent/Executor;

    iput-object p3, p0, Lmgc;->c:Lahac;

    .line 2
    iput-object p4, p0, Lmgc;->d:Landroid/content/Context;
...
.method public final a(Ljava/lang/String;Landroid/widget/ImageView;)Laflh;
    ...
    invoke-virtual {p0, p1, p2}, Lmgc;->a([BLandroid/widget/ImageView;)Laflh;
    ...
    .line 10
    :goto_0
    const-string v3, "BasicImageLoader"
    ...
    invoke-direct {v2, p0, p1, v0, p2}, Lmgb;-><init>(Lmgc;Ljava/lang/String;Laflx;Landroid/widget/ImageView;)V

    iget-object p1, p0, Lmgc;->b:Ljava/util/concurrent/Executor;
    ...
    .line 8
    :cond_3
    iget-object p1, p0, Lmgc;->d:Landroid/content/Context;
    ...
    invoke-static {p1, p2}, Lmgc;->a(Landroid/graphics/Bitmap;Landroid/widget/ImageView;)V
...
.method public final a([BLandroid/widget/ImageView;)Laflh;
    ...
    invoke-virtual {p0, p1, p2}, Lmgc;->b([BLandroid/widget/ImageView;)V
...
.method public final b([BLandroid/widget/ImageView;)V
    ...
    iget-object v0, p0, Lmgc;->c:Lahac;
    ...
    invoke-static {p1, v0}, Lmey;->a([BF)Landroid/graphics/Bitmap;
