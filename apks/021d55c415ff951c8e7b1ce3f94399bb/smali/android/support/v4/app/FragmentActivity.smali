...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lj;-><init>(Landroid/support/v4/app/FragmentActivity;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    new-instance v0, Lk;

    invoke-direct {v0, p0}, Lk;-><init>(Landroid/support/v4/app/FragmentActivity;)V

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:Ln;
...
# virtual methods
.method final a(Ljava/lang/String;ZZ)LE;
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;
    ...
    invoke-direct {v0, p1, p0, p2}, LE;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentActivity;Z)V

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;
    ...
    :cond_2
    invoke-virtual {v0, p0}, LE;->a(Landroid/support/v4/app/FragmentActivity;)V
...
.method public final a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v4/app/FragmentActivity;->e:Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:LE;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lo;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getSupportLoaderManager()Landroid/support/v4/app/LoaderManager;
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)LE;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->a:LE;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    iget-object v1, v1, Lo;->b:Ljava/util/ArrayList;
...
.method public onBackPressed()V
    ...
    invoke-virtual {v0}, Lo;->popBackStackImmediate()Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->a:Ln;

    invoke-virtual {v0, p0, v2, v1}, Lo;->a(Landroid/support/v4/app/FragmentActivity;Ln;Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v2, v0, Lm;->b:Ljava/util/HashMap;

    iput-object v2, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    if-eqz v0, :cond_3

    iget-object v0, v0, Lm;->a:Ljava/util/ArrayList;

    :goto_0
    invoke-virtual {v3, v2, v0}, Lo;->a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p2, v2}, Lo;->a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {v1, v2}, Lo;->findFragmentById(I)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v5}, Lo;->findFragmentByTag(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v3}, Lo;->findFragmentById(I)Landroid/support/v4/app/Fragment;
    ...
    iput-boolean v7, v4, Landroid/support/v4/app/Fragment;->i:Z
    ...
    :goto_1
    iput v1, v4, Landroid/support/v4/app/Fragment;->j:I

    iput v3, v4, Landroid/support/v4/app/Fragment;->k:I

    iput-object v5, v4, Landroid/support/v4/app/Fragment;->b:Ljava/lang/String;

    iput-boolean v7, v4, Landroid/support/v4/app/Fragment;->j:Z

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    iput-object v1, v4, Landroid/support/v4/app/Fragment;->a:Lo;
    ...
    invoke-virtual {v1, v4, v7}, Lo;->a(Landroid/support/v4/app/Fragment;Z)V
    ...
    :cond_7
    iget-boolean v4, v1, Landroid/support/v4/app/Fragment;->j:Z
    ...
    :cond_8
    iput-boolean v7, v1, Landroid/support/v4/app/Fragment;->j:Z

    iget-boolean v3, v1, Landroid/support/v4/app/Fragment;->o:Z
    ...
    invoke-virtual {v3, v1}, Lo;->b(Landroid/support/v4/app/Fragment;)V
...
.method public onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, p2}, Lo;->a(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, p2}, Lo;->b(Landroid/view/MenuItem;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {v0, p2}, Lo;->a(Landroid/view/Menu;)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    invoke-virtual {v2, p3}, Lo;->a(Landroid/view/Menu;)Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lo;->a()Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-virtual {v7}, LE;->g()V

    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;
    ...
    iput-object v3, v0, Lm;->a:Ljava/lang/Object;

    iput-object v4, v0, Lm;->b:Ljava/lang/Object;

    iput-object v3, v0, Lm;->a:Ljava/util/HashMap;

    iput-object v5, v0, Lm;->a:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;

    iput-object v1, v0, Lm;->b:Ljava/util/HashMap;
...
.method protected onStart()V
    ...
    iput-boolean v3, p0, Landroid/support/v4/app/FragmentActivity;->a:Z

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    invoke-virtual {v1}, Lo;->d()V

    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:Lo;

    invoke-virtual {v1}, Lo;->b()V
    ...
    iput-boolean v3, p0, Landroid/support/v4/app/FragmentActivity;->h:Z

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:LE;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:LE;

    invoke-virtual {v1}, LE;->a()V
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v2}, LE;->d()V

    invoke-virtual {v2}, LE;->f()V
    ...
    invoke-virtual {p0, v1, v2, v0}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)LE;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->a:LE;
