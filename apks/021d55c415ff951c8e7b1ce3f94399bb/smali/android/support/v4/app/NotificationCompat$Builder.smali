...
.field public a:Landroid/support/v4/app/NotificationCompat$Style;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/app/Notification;

    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/content/Context;

    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/app/Notification;
...
.method public build()Landroid/app/Notification;
    ...
    invoke-static {}, Landroid/support/v4/app/NotificationCompat;->a()LK;

    move-result-object v0

    invoke-interface {v0, p0}, LK;->a(Landroid/support/v4/app/NotificationCompat$Builder;)Landroid/app/Notification;
...
.method public setContentIntent(Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/app/PendingIntent;
...
.method public setContentTitle(Ljava/lang/CharSequence;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Ljava/lang/CharSequence;
...
.method public setFullScreenIntent(Landroid/app/PendingIntent;Z)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->b:Landroid/app/PendingIntent;

    const/16 v0, 0x80

    invoke-direct {p0, v0, p2}, Landroid/support/v4/app/NotificationCompat$Builder;->a(IZ)V
...
.method public setLargeIcon(Landroid/graphics/Bitmap;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/graphics/Bitmap;
...
.method public setLights(III)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/app/Notification;

    iget-object v4, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/app/Notification;
...
.method public setProgress(IIZ)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->c:I

    iput p2, p0, Landroid/support/v4/app/NotificationCompat$Builder;->d:I

    iput-boolean p3, p0, Landroid/support/v4/app/NotificationCompat$Builder;->b:Z
...
.method public setStyle(Landroid/support/v4/app/NotificationCompat$Style;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/support/v4/app/NotificationCompat$Style;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/support/v4/app/NotificationCompat$Style;
...
.method public setSubText(Ljava/lang/CharSequence;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->d:Ljava/lang/CharSequence;
...
.method public setTicker(Ljava/lang/CharSequence;Landroid/widget/RemoteViews;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object p2, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/widget/RemoteViews;
...
.method public setUsesChronometer(Z)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-boolean p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->a:Z
