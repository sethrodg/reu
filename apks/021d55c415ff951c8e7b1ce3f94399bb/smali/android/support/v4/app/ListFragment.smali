...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, LC;-><init>(Landroid/support/v4/app/ListFragment;)V

    iput-object v0, p0, Landroid/support/v4/app/ListFragment;->a:Ljava/lang/Runnable;

    new-instance v0, LD;

    invoke-direct {v0, p0}, LD;-><init>(Landroid/support/v4/app/ListFragment;)V

    iput-object v0, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/AdapterView$OnItemClickListener;
...
.method private a(ZZ)V
    ...
    invoke-direct {p0}, Landroid/support/v4/app/ListFragment;->j()V
    ...
    :cond_0
    iget-boolean v0, p0, Landroid/support/v4/app/ListFragment;->a:Z
    ...
    :cond_1
    iput-boolean p1, p0, Landroid/support/v4/app/ListFragment;->a:Z
...
.method private j()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/ListFragment;->a:Z

    iget-object v0, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/ListView;

    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->a:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/TextView;

    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Landroid/support/v4/app/ListFragment;->d:Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ListFragment;->d:Landroid/view/View;

    if-eqz v0, :cond_8

    iget-object v0, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/ListView;

    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->d:Landroid/view/View;
    ...
    :cond_8
    iget-object v0, p0, Landroid/support/v4/app/ListFragment;->a:Ljava/lang/CharSequence;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/TextView;

    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->a:Ljava/lang/CharSequence;
...
.method public onDestroyView()V
    ...
    iput-object v2, p0, Landroid/support/v4/app/ListFragment;->d:Landroid/view/View;

    iput-object v2, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/TextView;
...
.method public setEmptyText(Ljava/lang/CharSequence;)V
    ...
    :cond_1
    iput-object p1, p0, Landroid/support/v4/app/ListFragment;->a:Ljava/lang/CharSequence;
...
.method public setListAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object v3, p0, Landroid/support/v4/app/ListFragment;->a:Landroid/widget/ListView;
    ...
    iget-boolean v3, p0, Landroid/support/v4/app/ListFragment;->a:Z
